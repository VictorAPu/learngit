...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(pid_Task, PID_Task, osPriorityNormal, 0, 128);
...
void PID_Task(void const * argument)
{
  ...
  for(;;)
  {
		Angle_pitch(target_pitch_angle);
		Angle_yaw(target_yaw_angle);
		CAN1_SendCurrent(0x1FF,PID_pitch_6020Vel.fpU,0,0,0);
		CAN2_SendCurrent(0x1FF,PID_yaw_6020Vel.fpU,0,0,0);
    osDelay(1);
  }
